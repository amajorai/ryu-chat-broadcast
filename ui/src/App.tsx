			...
			<div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-5 py-8 sm:px-8 sm:py-10">
				<header className="flex items-start justify-between gap-5">
					<div className="flex min-w-0 items-start gap-4">
						<div
							aria-hidden="true"
							className="grid size-12 shrink-0 place-items-center rounded-2xl bg-primary/12 font-semibold text-2xl text-primary"
						>
							↗
						</div>
				...
				<section className="overflow-hidden rounded-3xl border bg-card shadow-[0_12px_40px_-28px_color-mix(in_oklch,var(--foreground),transparent_35%)]">
					<div className="border-b px-5 py-5 sm:px-6">
						<div className="flex flex-wrap items-start justify-between gap-4">
							<div>
								<h2 className="font-semibold text-lg">Choose chats</h2>
				...
				{results.length > 0 ? (
					<section className="rounded-2xl border bg-card p-4">
						<div className="flex items-center justify-between gap-3">
							<h2 className="font-semibold text-sm">Latest delivery</h2>
							<span className="text-muted-foreground text-xs">
								{
